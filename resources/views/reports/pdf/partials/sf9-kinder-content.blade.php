...
<div class="school-header">
    ...
    <h2 style="margin-top: 10px;">KINDERGARTEN PROGRESS REPORT (SF9)</h2>
...
<table class="no-border" style="margin-bottom: 10px; font-size: 9pt;">
    ...
    <tr>
        ...
        <td class="text-left" style="padding: 2px 0; border-bottom: 1px solid #999;">Kindergarten</td>
...
<!-- Developmental Domains Table -->
<p style="font-size: 9pt; margin-bottom: 5px;"><strong>Developmental Domains Assessment</strong></p>
<p style="font-size: 7pt; margin-bottom: 5px; color: #666;">B = Beginning &bull; D = Developing &bull; P = Proficient</p>
<table style="margin-bottom: 10px;">
    ...
    <tbody>
        @foreach($domainAssessments as $da)
            <tr>
